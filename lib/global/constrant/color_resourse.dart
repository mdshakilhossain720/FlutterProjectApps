...
class ColorRes{
 ...
 // static ThemeController themeFind = Get.find<ThemeController>();
  ...
  static Color getDarkLightAppBarColor(context) {
    ...
    return (theme == Brightness.dark) ? darkAppBarBgColor : greyShadded200;
  }
  static Color getDarkLightBgColor(context) {
    final theme = Theme.of(context).brightness;
    return (theme == Brightness.dark) ? darkScaffoldBgColor : greyShadded;
  }
  ...
  // * Dark Mode Color */
  static const Color darkAppBarBgColor = Color(0xFF252B48);
  static const Color darkScaffoldBgColor = Color(0xFF212741);
